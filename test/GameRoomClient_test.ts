import GameRoomClient from '../src/OLDGameRoomClient';
...
describe('GameRoomClient Tests', () => {
  ...
  describe('connection tests:', () => {
    ...
    test('can request initial state', async () => {
      ...
      expect(initialState.activePlayerId).toBe(null);
      expect(initialState.orderedPlayerIds).toStrictEqual(mockPlayerIds);
    });
